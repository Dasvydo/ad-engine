...
# Re-measured 2026-09-18, after the two branches merged: three of the original four
# are now caught. "Save ten hours a month" and "Save hours every week" fell to the
# spelled-out-quantity patterns; "Cut your reply time in half" to the worded
# time-reduction ones.
#
# The survivor stays open deliberately. Any pattern broad enough to catch a vague
# comparative also catches "More clients, same team" - the recommended headline in
# creative/capacity.json. A gate that blocks the approved copy gets switched off,
# so this one is a judgement call a human makes, not a regex.
GATE_BLIND_SPOTS = [
